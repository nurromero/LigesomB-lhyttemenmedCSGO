namespace LigesomBålhyttemenmedCSGO
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Player player1 = new Player(001, "Niya", "CT", 100, 999, 0);
            Console.WriteLine(player1);

            Weapon m4a4 = new Weapon("M4A4", 100, 999, 0, 1000, "CT");

            Armoury.Instance.Create("CT", 1, m4a4);
            Weapon weapon = Armoury.Instance.BuyWeapon("CT", 1, player1);
